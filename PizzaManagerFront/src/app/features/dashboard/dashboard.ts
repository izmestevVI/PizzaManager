...
@Component({
  ...
  imports: [LucideAngularModule, DialogModule, WidgetLayout, WidgetLoadForecast, WidgetLatestOrders, WidgetTopPizzas, WidgetSalesChart, CardLayout, CardRevenue, CardOrders, CardAverageBill, CardWaiting],
